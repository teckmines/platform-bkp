...
const handleSvgClick =(id,data,type)=>{
  ...
  // newdata.push(data)
  // if(data != undefined){
  // const url = `/getVolumeReport/${data.trip_id}`
  //   axios({
  //   method: 'GET',
  //   url: url,
  //   }).then(response => {
    ...
    return (
        <Box>           
            <Box className="pagebackground">
                ...
                {!viewFlag?
                <Paper className='formpaper' style={{paddingBottom:'1rem'}}>
        <Grid container spacing={1} style={{background:'#bfe1f3', borderTopLeftRadius: '20px', borderTopRightRadius: '20px', marginLeft: '0.01rem' , width: 'auto'}}>
            <Grid item xs={6}>
                <Typography className='formHeader'>Truck Volumne Analysis - Report
                </Typography>
        ...
        <Paper className='formpaper'>
                ...
                :<Paper className='formpaper'>
                    ...
                    <Grid item xs={6} alignContent="flex-start">
                        <Typography className='formHeader'>Truck Volume Analysis - Report
                        </Typography>
                ...
                <TruckVolumeReportDialog data={selectedRowData} />
                </Paper>
...
export default TruckVolumeReport;