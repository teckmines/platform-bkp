        ...
        <Box>          
            <Box className="pagebackground">
                <Grid container spacing={1} style={{padding:'2.5rem'}}>
                    <Grid item xs={4}>
                        <Typography className='pageHeader'>Truck Details</Typography>
                    ...
                    <TableContainer component={Paper}>
                        <Table sx={{ minWidth: 700 }} aria-label="customized table">
                            ...
                            <TableRow>
                                ...
                                <StyledTableCell>RFID No</StyledTableCell>
                                <StyledTableCell>Truck Owner</StyledTableCell>
                                <StyledTableCell>Contractor Company</StyledTableCell>
                                <StyledTableCell>Contractor GSTIN</StyledTableCell>
                            ...
                            {rowData.map((row) => (
                                ...
                                <StyledTableCell>{row.rfid_tag_no}</StyledTableCell>
                                <StyledTableCell>{row.truck_owner}</StyledTableCell>
                                <StyledTableCell>{row.contractor_company}</StyledTableCell>
                                <StyledTableCell>{row.contractor_gstin}</StyledTableCell>
                ...
                <Paper className='formpaper'>
                    ...
                    <TruckForm callback={handleCallback} editData={editData} formState={formState} />
                </Paper>
                }
            </Box>
        </Box>
