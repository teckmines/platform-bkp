    ...
    return (
        <Box>           
            ...
            <Grid container spacing={1} style={{padding:'2.5rem'}}>
                <Grid item xs={4}>
                    <Typography className='pageHeader'>Mine Details</Typography>
            ...
            {!addform ? <Paper className='tablepaper'>
                    ...
                    <TableContainer component={Paper}>
                        <Table sx={{ minWidth: 700 }} aria-label="customized table">
                            ...
                            <TableRow>
                                ...
                                <StyledTableCell>Mine Name</StyledTableCell>
                                <StyledTableCell>Mine Registration No</StyledTableCell>
                            ...
                            {rowData.map((row) => (
                                ...
                                <StyledTableCell>{row.mine_name}</StyledTableCell>
                ...
                <Paper className='formpaper'>
                    ...
                    <MineForm callback={handleCallback} editData={editData} formState={formState} />
                </Paper>
                }
            </Box>
        </Box>
